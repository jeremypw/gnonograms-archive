...
public class Gnonogram_view : Gtk.Window
{
    ...
    public Gnonogram_view(Gnonogram_LabelBox rb, Gnonogram_LabelBox cb, Gnonogram_CellGrid dg)
    {
        ...
        //_info_box= new Box(Gtk.Orientation.HORIZONTAL,0); _info_box.set_homogeneous(false);
        ...
        //var vbox=new Box(Gtk.Orientation.VERTICAL,0); vbox.set_homogeneous(false);
    ...
    private MenuBar create_viewer_menubar()
    {
        ...
        var filemenuitem = new Gtk.MenuItem.with_mnemonic(_("_File"));
        var gamemenuitem = new Gtk.MenuItem.with_mnemonic(_("_Puzzle"));
        var settingsmenuitem = new Gtk.MenuItem.with_mnemonic(_("_Settings"));
        var viewmenuitem = new Gtk.MenuItem.with_mnemonic(_("_View"));
        var helpmenuitem = new Gtk.MenuItem.with_mnemonic(_("_Help"));
        ...
        filemenuitem.set_submenu(filesubmenu);
            ...
            var savepictomenuitem = new Gtk.MenuItem.with_mnemonic(_("_Save as Picto puzzle"));
            filesubmenu.add(savepictomenuitem);
            filesubmenu.add(new SeparatorMenuItem());
            var importmenuitem=new Gtk.MenuItem.with_mnemonic(_("_Import from image"));
        ...
        gamemenuitem.set_submenu(gamesubmenu);
            ...
            _checkerrorsmenuitem=new Gtk.MenuItem.with_mnemonic(_("Show _Incorrect cells"));
            gamesubmenu.add(_checkerrorsmenuitem);
            _checkerrorsmenuitem.set_sensitive(false);
            gamesubmenu.add(new SeparatorMenuItem());
            _restartmenuitem=new Gtk.MenuItem.with_mnemonic(_("_Restart"));
            gamesubmenu.add(_restartmenuitem);
            _pausemenuitem=new Gtk.MenuItem.with_mnemonic(_("_Pause"));
            gamesubmenu.add(_pausemenuitem);

            gamesubmenu.add(new SeparatorMenuItem());
            _hintmenuitem=new Gtk.MenuItem.with_mnemonic(_("_Get hint"));
            gamesubmenu.add(_hintmenuitem);
            var computersolvemenuitem=new Gtk.MenuItem.with_mnemonic(_("_Let computer solve it"));
            gamesubmenu.add(computersolvemenuitem);
            var computergeneratemenuitem=new Gtk.MenuItem.with_mnemonic(_("_Computer generated puzzle"));
            gamesubmenu.add(computergeneratemenuitem);

            gamesubmenu.add(new SeparatorMenuItem());
            var editmenuitem=new Gtk.MenuItem.with_mnemonic(_("_Edit puzzle"));
            gamesubmenu.add(editmenuitem);

            var trimmenuitem=new Gtk.MenuItem.with_mnemonic(_("_Trim blank edges"));
            gamesubmenu.add(trimmenuitem);

        var settingssubmenu=new Gtk.Menu();
        settingsmenuitem.set_submenu(settingssubmenu);
            var colormenuitem=new Gtk.MenuItem.with_mnemonic(_("_Colors ..."));
            settingssubmenu.add(colormenuitem);
            var fontmenuitem=new Gtk.MenuItem.with_mnemonic(_("_Font ..."));
            settingssubmenu.add(fontmenuitem);
            _resizemenuitem=new Gtk.MenuItem.with_mnemonic(_("_Resize ..."));
            settingssubmenu.add(_resizemenuitem);
            _grademenuitem=new Gtk.MenuItem.with_mnemonic(_("_Difficulty ..."));
            settingssubmenu.add(_grademenuitem);
            var gamedirmenuitem=new Gtk.MenuItem.with_mnemonic(_("_Puzzle folder"));
            settingssubmenu.add(gamedirmenuitem);
            var gamesdirsubmenu=new Gtk.Menu();
                var defaultgamedirmenuitem=new Gtk.MenuItem.with_mnemonic(_("Default"));
                var customgamedirmenuitem=new Gtk.MenuItem.with_mnemonic(_("Custom ..."));
            ...
            var patternsmenuitem=new Gtk.MenuItem.with_label(_("Cell Patterns"));
            settingssubmenu.add(patternsmenuitem);
                var patternssubmenu=new Gtk.Menu();
                    var plainpatternmenuitem=new Gtk.MenuItem.with_label(_("Plain"));
                    var radialpatternmenuitem=new Gtk.MenuItem.with_label(_("Circle"));
            ...
            _defaultsmenuitem=new Gtk.MenuItem.with_mnemonic(_("_Reset all to default"));
            settingssubmenu.add(_defaultsmenuitem);

        var viewsubmenu=new Gtk.Menu();
        ...
        var helpsubmenu=new Gtk.Menu();
        helpmenuitem.set_submenu(helpsubmenu);
            var htmlmanualmenuitem=new Gtk.MenuItem.with_mnemonic(_("Contents"));
            helpsubmenu.add(htmlmanualmenuitem);
            var aboutmenuitem=new Gtk.MenuItem.with_mnemonic(_("About"));
    ...
    private void create_viewer_toolbar()
    {
        ...
        grade_tool.create_menu_proxy.connect(()=>{
            var grademenuitem2=new Gtk.MenuItem.with_mnemonic(_("_Difficulty"));
    ...
    {
        Gdk.Pixbuf gnonogram_pb=null;
        try
        {
            gnonogram_pb= new Gdk.Pixbuf.from_file_at_scale(Resource.icon_dir+"/"+Resource.LOGOFILENAME,
                                                                                                                    48,
                                                                                                                    48,
                                                                                                                    true);
        }
        catch (GLib.Error e){stdout.printf("Failed to load about logo");}
        show_about_dialog (null,
                       "program-name", _("Gnonograms2"),
                       "version", _VERSION,
                       "comments", _("Design and solve Nonogram puzzles"),
                       "license","Gnonograms2 is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 2 of the License, or (at your option) any later version.\n\nGnonogram is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.\n\nYou should have received a copy of the GNU General Public License along with this program; if not, write to the Free Software Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301 USA\n\nAny puzzles distributed with the program are licensed under the Creative Commons Attribution Share-Alike license.  A copy of the license should have been distributed with the program, if not, see http://creativecommons.org/licenses/ \nOn Debian systems, the complete text of the GNU General Public License version 2 can be found in /usr/share/common-licenses/GPL-2",
                       "wrap_license",true,
                       "logo", gnonogram_pb,
                       "title", _("About Gnonograms2"),
