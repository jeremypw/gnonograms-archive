...
void resource_init (const gchar* arg0) {
	...
	if (resource_installed) {
		...
		_tmp19_ = _tmp18_;
		_tmp20_ = g_strconcat (_tmp19_, "/share/gnonogram", NULL);
		_g_free0 (_tmp13_);
		_tmp13_ = _tmp20_;
		_g_free0 (_tmp19_);
	...
	_tmp26_ = g_strdup ("/media/shared/shared_data/Vala/Gnonograms/Manual");
	_tmp27_ = _tmp26_;
	_g_free0 (resource_manual_dir);
	resource_manual_dir = _tmp27_;
	_tmp28_ = config_get_instance ();
	_tmp29_ = _tmp28_;
	_tmp30_ = g_strconcat (resource_resource_dir, "/games", NULL);
	_tmp31_ = config_get_game_dir (_tmp29_, _tmp30_);
	_tmp32_ = _tmp31_;
	_g_free0 (resource_game_dir);
	resource_game_dir = _tmp32_;
	_g_free0 (_tmp30_);
	_config_unref0 (_tmp29_);
	_tmp33_ = config_get_instance ();
	_tmp34_ = _tmp33_;
	_tmp35_ = config_get_game_name (_tmp34_, RESOURCE_DEFAULTGAMENAME);
	_tmp36_ = _tmp35_;
	_g_free0 (resource_game_name);
	resource_game_name = _tmp36_;
	_config_unref0 (_tmp34_);
	_tmp37_ = g_new0 (GdkColor, 2 * 4);
	_tmp38_ = _tmp37_;
	resource_colors = (g_free (resource_colors), NULL);
	resource_colors_length1 = 2;
	resource_colors_length2 = 4;
	resource_colors = _tmp38_;
	setting = (gint) GAME_STATE_SETTING;
	gdk_color_parse ("GREY", &_tmp39_);
	resource_colors[(setting * resource_colors_length2) + ((gint) CELL_STATE_UNKNOWN)] = _tmp39_;
	gdk_color_parse ("WHITE", &_tmp40_);
	resource_colors[(setting * resource_colors_length2) + ((gint) CELL_STATE_EMPTY)] = _tmp40_;
	gdk_color_parse ("BLACK", &_tmp41_);
	resource_colors[(setting * resource_colors_length2) + ((gint) CELL_STATE_FILLED)] = _tmp41_;
	gdk_color_parse ("RED", &_tmp42_);
	resource_colors[(setting * resource_colors_length2) + ((gint) CELL_STATE_ERROR)] = _tmp42_;
	solving = (gint) GAME_STATE_SOLVING;
	gdk_color_parse ("GREY", &_tmp43_);
	resource_colors[(solving * resource_colors_length2) + ((gint) CELL_STATE_UNKNOWN)] = _tmp43_;
	gdk_color_parse ("YELLOW", &_tmp44_);
	resource_colors[(solving * resource_colors_length2) + ((gint) CELL_STATE_EMPTY)] = _tmp44_;
	gdk_color_parse ("BLUE", &_tmp45_);
	resource_colors[(solving * resource_colors_length2) + ((gint) CELL_STATE_FILLED)] = _tmp45_;
	gdk_color_parse ("RED", &_tmp46_);
	resource_colors[(solving * resource_colors_length2) + ((gint) CELL_STATE_ERROR)] = _tmp46_;
	_tmp47_ = config_get_instance ();
	_tmp48_ = _tmp47_;
	_tmp50_ = config_get_colors (_tmp48_, &_tmp49_);
	config_colors = (_tmp51_ = _tmp50_, _config_unref0 (_tmp48_), _tmp51_);
	config_colors_length1 = _tmp49_;
	_config_colors_size_ = _tmp49_;
	gdk_color_parse (config_colors[0], &_tmp52_);
	resource_colors[(setting * resource_colors_length2) + ((gint) CELL_STATE_EMPTY)] = _tmp52_;
	gdk_color_parse (config_colors[1], &_tmp53_);
	resource_colors[(setting * resource_colors_length2) + ((gint) CELL_STATE_FILLED)] = _tmp53_;
	gdk_color_parse (config_colors[2], &_tmp54_);
	resource_colors[(solving * resource_colors_length2) + ((gint) CELL_STATE_EMPTY)] = _tmp54_;
	gdk_color_parse (config_colors[3], &_tmp55_);
	resource_colors[(solving * resource_colors_length2) + ((gint) CELL_STATE_FILLED)] = _tmp55_;
	_tmp56_ = g_strdup ("Ariel");
	_tmp57_ = _tmp56_;
	_g_free0 (resource_font_desc);
	resource_font_desc = _tmp57_;
	...
	resource_MINORGRIDDASH = _tmp59_;
