...
static GtkMenuBar* gnonogram_view_create_viewer_menubar (Gnonogram_view* self) {
	...
	gtk_widget_set_sensitive (GTK_WIDGET (_data1_->debugmenuitem), FALSE);
...
static void gnonogram_view_create_viewer_toolbar (Gnonogram_view* self) {
	...
	_tmp22_ = (GtkSeparatorToolItem*) gtk_separator_tool_item_new ();
	_tmp23_ = g_object_ref_sink (_tmp22_);
	gtk_container_add (GTK_CONTAINER (self->_toolbar), GTK_WIDGET (_tmp23_));
	_g_object_unref0 (_tmp23_);
	_tmp24_ = g_strconcat (resource_icon_dir, "/laptop.png", NULL);
	_tmp25_ = (GtkImage*) gtk_image_new_from_file (_tmp24_);
	solve_icon = (_tmp26_ = g_object_ref_sink (_tmp25_), _g_free0 (_tmp24_), _tmp26_);
	_tmp27_ = _ ("Solve");
	_tmp28_ = (GtkToolButton*) gtk_tool_button_new (GTK_WIDGET (solve_icon), _tmp27_);
	solve_tool = g_object_ref_sink (_tmp28_);
	_tmp29_ = _ ("Solve by computer");
	gtk_tool_item_set_tooltip_text (GTK_TOOL_ITEM (solve_tool), _tmp29_);
	gtk_container_add (GTK_CONTAINER (self->_toolbar), GTK_WIDGET (solve_tool));
	_tmp30_ = g_strconcat (resource_icon_dir, "/Dices.png", NULL);
	_tmp31_ = (GtkImage*) gtk_image_new_from_file (_tmp30_);
	random_icon = (_tmp32_ = g_object_ref_sink (_tmp31_), _g_free0 (_tmp30_), _tmp32_);
	_tmp33_ = _ ("Random");
	_tmp34_ = (GtkToolButton*) gtk_tool_button_new (GTK_WIDGET (random_icon), _tmp33_);
	random_tool = g_object_ref_sink (_tmp34_);
	_tmp35_ = _ ("Generate a random game");
	gtk_tool_item_set_tooltip_text (GTK_TOOL_ITEM (random_tool), _tmp35_);
	...
	_tmp40_ = (GtkSeparatorToolItem*) gtk_separator_tool_item_new ();
	_tmp41_ = g_object_ref_sink (_tmp40_);
	gtk_container_add (GTK_CONTAINER (self->_toolbar), GTK_WIDGET (_tmp41_));
	_g_object_unref0 (_tmp41_);
	_tmp42_ = g_strconcat (resource_icon_dir, "/newsheet.png", NULL);
	_tmp43_ = (GtkImage*) gtk_image_new_from_file (_tmp42_);
	resize_icon = (_tmp44_ = g_object_ref_sink (_tmp43_), _g_free0 (_tmp42_), _tmp44_);
	_tmp45_ = _ ("Resize");
	_tmp46_ = (GtkToolButton*) gtk_tool_button_new (GTK_WIDGET (resize_icon), _tmp45_);
	resize_tool = g_object_ref_sink (_tmp46_);
	_tmp47_ = _ ("Change dimensions of the game grid");
	gtk_tool_item_set_tooltip_text (GTK_TOOL_ITEM (resize_tool), _tmp47_);
	gtk_container_add (GTK_CONTAINER (self->_toolbar), GTK_WIDGET (resize_tool));
	_tmp48_ = (GtkToolButton*) gtk_tool_button_new_from_stock (GTK_STOCK_ZOOM_IN);
	zoom_in_tool = g_object_ref_sink (_tmp48_);
	_tmp49_ = _ ("Increase font size");
	gtk_tool_item_set_tooltip_text (GTK_TOOL_ITEM (zoom_in_tool), _tmp49_);
	gtk_container_add (GTK_CONTAINER (self->_toolbar), GTK_WIDGET (zoom_in_tool));
	_tmp50_ = (GtkToolButton*) gtk_tool_button_new_from_stock (GTK_STOCK_ZOOM_OUT);
	zoom_out_tool = g_object_ref_sink (_tmp50_);
	_tmp51_ = _ ("Decrease font size");
	gtk_tool_item_set_tooltip_text (GTK_TOOL_ITEM (zoom_out_tool), _tmp51_);
